# Generated by Django 4.2.7 on 2025-05-02 21:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrador'), ('BIBLIOTECARIO', 'Bibliotecario'), ('USUARIO', 'Usuario Regular')], default='USUARIO', max_length=20, verbose_name='Rol')),
            ...
            options={
                ...
                'permissions': [('can_manage_books', 'Puede gestionar libros'), ('can_manage_users', 'Puede gestionar usuarios'), ('can_view_statistics', 'Puede ver estadísticas')],
            },
            managers=[
